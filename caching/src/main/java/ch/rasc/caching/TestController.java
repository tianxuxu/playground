...
public class TestController {
	...
	public List<String> getSomething() {
		...
		return Lists.newArrayList(
				testService.getData("one"), 
				testService.getData("two"),
				testService.getData("three"),
				testService.getData("four"),
				testService.getData("five"),
				testService.getData("six"),
				testService.getData("seven"),
				testService.getData("eight"),
				testService.getData("nine"),
				testService.getData("ten"),
