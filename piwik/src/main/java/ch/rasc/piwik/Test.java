...
public class Test {
	...
	public static void main(String[] args) throws PiwikException {
		SimplePiwikTracker tracker = new SimplePiwikTracker(
				"http://192.168.23.130/piwik.php");
		tracker.setIdSite(1);
		tracker.setUserAgent("Java");
		tracker.setAcceptLanguage(Locale.ENGLISH);
		URL url = tracker.getPageTrackURL("test");
		System.out.println(url);
		ResponseData rd = tracker.sendRequest(url);
		...
		// http://192.168.23.130/piwik.php?idsite=1&rec=1
	}
	...
	// */
	// @Test
	// public void testSetAcceptLanguage_String() throws PiwikException,
	...
	// */
	// @Test
	// public void testSetAcceptLanguage_Locale() throws PiwikException,
	// MalformedURLException {
	...
	// */
	// @Test
	// public void testSetUrlReferrer_String() throws PiwikException,
	// MalformedURLException {
	// String urlReferrer = "";
	// tracker.setVisitorId(SimplePiwikTrackerTest.TEST_VISITORID);
	...
	// String expResult = "idsite=0&rec=1&apiv=1&_id=" +
	// SimplePiwikTrackerTest.TEST_VISITORID + "&cookie=false&r=";
	...
	// index = rest.length();
	// }
	// String random = result.substring(generalpart.length(), generalpart.length() +
	// index);
	...
	// }
	//
	// private void assertFullUrl(final String expEnding, final String expApiurl, final
	// String result) {
	...
	// */
	// @Test
	// public void testGetGoalTrackURL_String() throws PiwikException,
	// MalformedURLException {
	// String goal = "testgoal";
	// tracker.setVisitorId(SimplePiwikTrackerTest.TEST_VISITORID);
	// String expResult = "&idgoal=testgoal";
	// this.assertFullUrl(expResult, "http://localhost/piwik/piwik.php?",
	// tracker.getGoalTrackURL(goal).toString());
	// }
	//
	// /**
	// * Test of getGoalTrackURL method, of class SimplePiwikTracker.
	// */
	// @Test
	// public void testGetGoalTrackURL_String_String() throws PiwikException,
	// MalformedURLException {
	// String goal = "testgoal";
	// String revenue = "1";
	// tracker.setVisitorId(SimplePiwikTrackerTest.TEST_VISITORID);
	...
	// this.assertFullUrl(expResult, "http://localhost/piwik/piwik.php?",
	// tracker.getGoalTrackURL(goal, revenue).toString());
	// }
	//
	// /**
	...
	// this.assertFullUrl(expResult, "http://localhost/piwik/piwik.php?",
	// tracker.getDownloadTrackURL(downloadurl).toString());
	// }
	//
	// /**
	...
	// this.assertFullUrl(expResult, "http://localhost/piwik/piwik.php?",
	// tracker.getLinkTrackURL(linkurl).toString());
	// }
	//
	// /**
	...
	// this.assertFullUrl(expResult, "http://localhost/piwik/piwik.php?",
	// tracker.getPageTrackURL(pagename).toString());
	// }
	//
	// /**
