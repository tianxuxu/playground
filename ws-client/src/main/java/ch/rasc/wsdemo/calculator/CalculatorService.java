...
public class CalculatorService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(ch.rasc.wsdemo.calculator.CalculatorService.class.getName());
	...
	public CalculatorService() {
		super(CALCULATORSERVICE_WSDL_LOCATION, new QName("http://wsdemo.ralscha.ch/",
				"CalculatorService"));
	}
	...
	public Calculator getCalculatorPort() {
		return super.getPort(new QName("http://wsdemo.ralscha.ch/", "CalculatorPort"),
				Calculator.class);
	}
