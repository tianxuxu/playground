...
public class HelloWorldImplService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(ch.rasc.wsdemo.helloworld.HelloWorldImplService.class
					.getName());
	...
	public HelloWorldImplService() {
		super(HELLOWORLDIMPLSERVICE_WSDL_LOCATION, new QName(
				"http://wsdemo.ralscha.ch/", "HelloWorldImplService"));
	}
	...
	public HelloWorldImpl getHelloWorldImplPort() {
		return super.getPort(new QName("http://wsdemo.ralscha.ch/",
				"HelloWorldImplPort"), HelloWorldImpl.class);
	}
	...
	public HelloWorldImpl getHelloWorldImplPort(WebServiceFeature... features) {
		return super.getPort(new QName("http://wsdemo.ralscha.ch/",
				"HelloWorldImplPort"), HelloWorldImpl.class, features);
	}
