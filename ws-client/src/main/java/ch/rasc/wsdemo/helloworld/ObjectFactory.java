 ...
 * generated in the ch.rasc.wsdemo.helloworld package. 
...
public class ObjectFactory {
	...
	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ch.rasc.wsdemo.helloworld
	 * 
	 */
