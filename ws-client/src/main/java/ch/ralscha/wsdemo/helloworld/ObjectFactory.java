package ch.ralscha.wsdemo.helloworld;
 ...
 * generated in the ch.ralscha.wsdemo.helloworld package. 
...
public class ObjectFactory {
	...
	private final static QName _SayHiResponse_QNAME = new QName("http://wsdemo.ralscha.ch/", "sayHiResponse");
	private final static QName _SayHi_QNAME = new QName("http://wsdemo.ralscha.ch/", "sayHi");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ch.ralscha.wsdemo.helloworld
	 * 
	 */
