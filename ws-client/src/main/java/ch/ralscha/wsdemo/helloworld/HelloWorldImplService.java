...
public class HelloWorldImplService extends Service {
	...
	private final static Logger logger = Logger.getLogger(ch.ralscha.wsdemo.helloworld.HelloWorldImplService.class
			.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = ch.ralscha.wsdemo.helloworld.HelloWorldImplService.class.getResource(".");
