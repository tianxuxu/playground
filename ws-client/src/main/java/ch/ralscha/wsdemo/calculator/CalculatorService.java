...
public class CalculatorService extends Service {
	...
	private final static Logger logger = Logger.getLogger(ch.ralscha.wsdemo.calculator.CalculatorService.class
			.getName());
	...
	static {
		...
		try {
			URL baseUrl;
			baseUrl = ch.ralscha.wsdemo.calculator.CalculatorService.class.getResource(".");
