...
/**
 * Has a number, a {@link Customer}, a {@link List} of {@link LineItem}s, and a boolean
 * that states whether or not the order has been delivered. There is a class variable that
 * contains the next order number.
 */
public class Order {
	...
	public double getValue() {
		Collection<Double> itemValues = Iterate.collect(this.lineItems,
				LineItem::getValue);

		return CollectionAdapter.adapt(itemValues).injectInto(0.0,
