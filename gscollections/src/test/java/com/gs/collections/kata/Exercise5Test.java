...
public class Exercise5Test extends CompanyDomainForKata {
	...
	public void filterOrderValues() {
		...
		/**
		 * Same exercise but don't use static utility - refactor the type of orders and
		 * {@link Customer#getOrders()} instead. Get the order values that are greater
		 * than 1.5.
		 */
		...
		Verify.assertContains(
				...
				null, this.company.getMostRecentCustomer().getOrders());
	}
	...
	public void filterOrders() {
		...
		/**
		 * Same exercise but don't use static utility - refactor the type of orders and
		 * {@link Customer#getOrders()} instead. Get the actual orders (not their double
