...
public class Exercise8Test extends CompanyDomainForKata {
	...
	public void totalOrderValuesByCity() {
		...
		Function2<Double, Customer, Double> aggregator = (result, customer) -> result
	...
	/**
	 * Extra credit. Aggregate the total order values by item. Hint: Look at
	 * {@link RichIterable#aggregateBy(Function, Function0, Function2)} and remember how
	 * to use {@link RichIterable#flatCollect(Function)} to get an iterable of all items.
	 */
	@Test
	public void totalOrderValuesByItem() {
		Function0<Double> zeroValueFactory = () -> 0.0;
		Function2<Double, LineItem, Double> aggregator = (result, lineItem) -> result
				+ lineItem.getValue();
	...
	/**
	 * Extra credit. Find all customers' line item values greater than 7.5 and sort them
	 * by highest to lowest price.
	 */
	@Test
	...
	/**
	 * Extra credit. Create a multimap where the values are customers and the key is the
	 * price of the most expensive item that the customer ordered.
	 */
	@Test
