...
public class Exercise2Test extends CompanyDomainForKata {
	/**
	 * Set up a {@link Predicate} that tests to see if a {@link Customer}'s city is
	 * "London"
	 */
	...
	public void customerFromLondonPredicate() {
		...
		Assert.assertEquals("Implement Customer.TO_CITY", "London",
	...
	/**
	 * Which customers come from London? Get a collection of those which do. Use the
	 * Predicate {@link #CUSTOMER_FROM_LONDON}.
	 */
	@Test
	...
	/**
	 * Which customers do not come from London? Get a collection of those which don't. Use
	...
	/**
	 * Which customers come from London? Which customers do not come from London? Get a
	 * collection of each in a single pass. Use the Predicate
	 * {@link #CUSTOMER_FROM_LONDON}.
	 */
	@Test
