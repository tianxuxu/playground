...
public class GeoliteImporter {
	...
	public void importData() throws IOException {
		...
		CSVReader reader = new CSVReader(new FileReader("D:\\_download\\GeoLiteCity_20101101\\GeoLiteCity-Location.csv"));
		reader.readNext();
		reader.readNext();
		String[] nextLine;
		...
		reader = new CSVReader(new FileReader("D:\\_download\\GeoLiteCity_20101101\\GeoLiteCity-Blocks.csv"));
		reader.readNext();
		reader.readNext();
