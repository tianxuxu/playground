...
public class GuavaOptional {
	...
	/**
	 * Provide the name of the capital of the provided state. This method uses Guava's Optional.fromNullable(T) to
	 * ensure that a non-null Optional instance is always returned with a non-null contained reference or without a
	 * contained reference.
	 *
	 * @param stateName State whose capital is desired.
	 * @return Instance of Optional possibly containing the capital corresponding to provided the state name, if
	 *         available.
	 */
	 ...
	 * @return Optional wrapper potentially containing Quotient from dividing dividend by divisor.
	 */
	...
	public static void main(String[] arguments) {
		...
		out.println("Quotient of " + dividend + " / " + divisor + " is " + quotientWrapper);
	}
}
