...
public enum FioFlagUnit {
	 ...
	 * precipIntensity: Millimeters per hour. precipAccumulation: Centimeters.
	 * temperature: Degrees Celsius. dewPoint: Degrees Celsius. windSpeed: Meters per
	 * second. pressure: Hectopascals (which are, conveniently, equivalent to the default
	 * millibars). visibility: Kilometers.
	 */
	SI("si"),
