...
public class FioResponse {
	...
	/**
	 * A data block containing the weather conditions minute-by-minute for the next hour. (This property’s name should
	 * be read as an adjective—analogously to "hourly" or "daily" and meaning "reckoned by the minute"—rather than as an
	 * adverb meaning "meticulously."
	 */
	...
	/**
	 * An array of alert objects, which, if present, contains any severe weather alerts, issued by a governmental
	 * weather authority, pertinent to the requested location.
	 */
	...
	public String toString() {
		return "FioResponse [latitude=" + latitude + ", longitude=" + longitude + ", timezone=" + timezone
				+ ", offset=" + offset + ", currently=" + currently + ", minutely=" + minutely + ", hourly=" + hourly
