...
public class FioFlag {
	...
	public String toString() {
		return "FioFlag [darkskyUnavailable=" + darkskyUnavailable
				+ ", darkskyStations=" + darkskyStations
				+ ", datapointStations=" + datapointStations + ", isdStations="
				+ isdStations + ", lampStations=" + lampStations
				+ ", metarStations=" + metarStations + ", metnoLicense="
				+ metnoLicense + ", sources=" + sources + ", units=" + units
				+ "]";
	}
