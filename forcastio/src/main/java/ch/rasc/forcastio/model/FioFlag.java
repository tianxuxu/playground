...
public class FioFlag {
	 ...
	 * temporary error (such as a radar station being down for maintenace) has made the data unavailable.
	 */
	...
	/**
	 * The presence of this property indicates that data from api.met.no was utilized in order to facilitate this
	 * request (as per their license agreement).
	 */
	@JsonProperty("metno-license")
	private List<String> metnoLicense;

	/**
	 * This property contains an array of IDs for each data source utilized in servicing this request. (For more
	 * information, see data sources, below.)
	 */
	private List<String> sources;

	/**
	 * The presence of this property indicates which units were used for the data in this request. (For more
	...
	public String toString() {
		return "FioFlag [darkskyUnavailable=" + darkskyUnavailable + ", darkskyStations=" + darkskyStations
				+ ", datapointStations=" + datapointStations + ", isdStations=" + isdStations + ", lampStations="
				+ lampStations + ", metarStations=" + metarStations + ", metnoLicense=" + metnoLicense + ", sources="
				+ sources + ", units=" + units + "]";
	}
