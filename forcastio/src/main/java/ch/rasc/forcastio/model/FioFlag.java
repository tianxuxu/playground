...
public class FioFlag {
	 ...
	 * supports the given location, but a temporary error (such as a radar
	...
	/**
	 * This property contains an array of IDs for each DataPoint station
	 ...
	 * servicing this request. (For more information, see data sources, below.)
	 */
	private List<String> sources;

	/**
	 * The presence of this property indicates which units were used for the
	 * data in this request. (For more information, see options, below.)
	 */
