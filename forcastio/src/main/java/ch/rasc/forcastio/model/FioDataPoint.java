 ...
 * midnight of that day. Data points in the daily data block (see below) are special:
 * instead of representing the weather phenomena at a given instant of time, they are an
 * aggregate point representing the weather phenomena that will occur over the entire day.
 * For precipitation fields, this aggregate is a maximum; for other fields, it is an
 * average.
 *
 */
public class FioDataPoint {
	 ...
	 * for display. If defined, this property will have one of the following values:
	 ...
	 * as additional values, such as hail, thunderstorm, or tornado, may be defined in the
	 * future.)
	 */
	...
	/**
	 * The UNIX time (that is, seconds since midnight GMT on 1 Jan 1970) of sunrise on the
	 * given day. (If no sunrise will occur on the given day, then the appropriate fields
	 * will be undefined. This can occur during summer and winter in very high or low
	 * latitudes.) (only defined on daily data points)
	 */
	private Date sunriseTime;

	/**
	 * The UNIX time (that is, seconds since midnight GMT on 1 Jan 1970) of sunset on the
	 * given day. (If no sunset will occur on the given day, then the appropriate fields
	 * will be undefined. This can occur during summer and winter in very high or low
	 * latitudes.) (only defined on daily data points)
	 */
	 ...
	 * is that a value of 0 corresponds to no precipitation, 0.002 corresponds to very
	 * light precipitation, 0.017 corresponds to light precipitation, 0.1 corresponds to
	 * moderate precipitation, and 0.4 corresponds to very heavy precipitation.
	 */
	...
	/**
	 * numerical values representing the maximumum expected intensity of precipitation
	 * (and the UNIX time at which it occurs) on the given day in inches of liquid water
	 * per hour. (only defined on daily data points)
	 */
	 ...
	 * precipitation occuring at the given time. (If precipIntensity is zero, then this
	 * property would be redundant and will therefore not be defined.)
	 */
	private Double precipProbability;

	/**
	 * A string representing the type of precipitation occurring at the given time. If
	 * defined, this property will have one of the following values: rain, snow, sleet
	...
	/*
	 * (only defined on daily data points): the amount of snowfall accumulation expected
	 * to occur on the given day. (If no accumulation is expected, this property will not
	 * be defined.)
	 */
	private Double precipAccumulation;

	/**
	 * (not defined on daily data points): A numerical value representing the temperature
	 * at the given time in degrees Fahrenheit.
	 */
	private Double temperature;

	/**
	 * (only defined on daily data points): numerical values representing the minimum and
	 * maximumum temperatures (and the UNIX times at which they occur) on the given day in
	 * degrees Fahrenheit.
	 */
	...
	public String toString() {
		return "FioDataPoint [time=" + time + ", summary=" + summary + ", icon=" + icon
				...
				+ ", precipIntensity=" + precipIntensity + ", precipIntensityError="
				+ precipIntensityError + ", precipIntensityMax=" + precipIntensityMax
				+ ", precipIntensityMaxTime=" + precipIntensityMaxTime
				+ ", precipProbability=" + precipProbability + ", precipType="
				+ precipType + ", precipAccumulation=" + precipAccumulation
				+ ", temperature=" + temperature + ", temperatureMin=" + temperatureMin
				+ ", temperatureMinTime=" + temperatureMinTime + ", temperatureMax="
				+ temperatureMax + ", temperatureMaxTime=" + temperatureMaxTime
				+ ", dewPoint=" + dewPoint + ", windSpeed=" + windSpeed
				+ ", windSpeedError=" + windSpeedError + ", windBearing=" + windBearing
				+ ", cloudCover=" + cloudCover + ", humidity=" + humidity + ", pressure="
				+ pressure + ", pressureError=" + pressureError + ", visibility="
				+ visibility + ", ozone=" + ozone + "]";
	}
